  ...
  return (
    ...
    <div className="relative flex flex-col min-h-screen">
      ...
      <main className="flex-grow" >
        <div className="relative" style={{zIndex:10,fontFamily:"DM Sans", fontWeight:"500", height: "90vh", background: "radial-gradient(at 40% 97%, #200f21 0px, transparent 50%), radial-gradient(at 61% 62%, #382039 0px, transparent 50%), radial-gradient(at 57% 28%, #5a3d5c 0px, transparent 50%), radial-gradient(at 36% 13%, #f638dc 0px, transparent 50%), #200f21" }}>
          <div className="container mx-auto px-4 py-36 flex flex-col lg:flex-row">
            <div className="lg:w-1/2 w-full mb-8 lg:mb-0 text-center lg:text-left">
              <h2 className="text-4xl lg:text-5xl font-light">
                ...
                <span className="text-orange-600 font-bold">PERFORMANCE</span><br />
        ...
        <div className="our-services-container mt-24 px-4 lg:px-0">
          <h2 className="our-services-title text-center text-3xl lg:text-4xl font-normal" style={{zIndex:10, fontFamily: "DM Sans", fontWeight: "700" }}>
            OUR SERVICES
          </h2>
